...
local function set_hl_groups()
    ...
    hl(0, "Function", { fg = "#a4aecc", bg = "NONE" })
    hl(0, "Identifier", { fg = "#c7c9d1", bg = "NONE" })
    hl(0, "Ignore", { fg = "NONE", bg = "NONE" })
    hl(0, "Include", { fg = "#a4aecc", bg = "NONE" })
    ...
    hl(0, "StatusLine", { fg = "#17181c", bg = "#828597" })
    hl(0, "StatusLineTerm", { fg = "#17181c", bg = "#828597" })
    hl(0, "StatusLineNC", { fg = "#3f455f", bg = "#101218" })
    hl(0, "StatusLineTermNC", { fg = "#3f455f", bg = "#101218" })
    hl(0, "StorageClass", { fg = "#85a0c7", bg = "NONE" })
    hl(0, "String", { fg = "#89b9c2", bg = "NONE" })
    hl(0, "Structure", { fg = "#85a0c7", bg = "NONE" })
    hl(0, "TabLine", { fg = "#828597", bg = "#1f2233" })
    hl(0, "TabLineFill", { fg = "#3f455f", bg = "#101218" })
    hl(0, "TabLineSel", { fg = "#17181c", bg = "#828597" })
    ...
    hl(0, "DiagnosticUnderlineOk", { fg = "NONE", bg = "NONE", sp = "#b5bf82", underline = true })
    ...
    hl(0, "DiagnosticOk", { fg = "#b5bf82", bg = "NONE" })
    ...
    hl(0, "DiagnosticSignOk", { fg = "#b5bf82", bg = "#1f2233" })
